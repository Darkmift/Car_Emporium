...
//////
//////
//$someProduct = new Vehicle('TEST01', 'someType', '$price', '$date_sold');
...
//
//Database::getInstance()->db_insert($injectarray[0], $injectarray[1], $someProduct->insertSQLArray());
//echo '<pre>' . print_r(debug_backtrace(), 1) . '</pre><hr>';
////////////////
$someVehicle = new Vehicle('TEST01', 'someType', '$price', '$date_sold', '$licensePlate');
...
Database::getInstance()->db_insert($injectarray[0], $injectarray[1], $someVehicle->insertSQLArray());
echo '<pre>' . print_r(debug_backtrace(), 1) . '</pre><hr>';
//
//
